    ...
    HTML: function (cafe1, cafe2, cafe3, body, sweet, acidity, bitterness, balance, location, title) {
        ...
        <body>
            ...
            <form action="/recommendPage/list/scope" method="POST">
                ...
                <input type="hidden" name="title" value="${title}">
                <input class="mapButton" type="submit" value="순위 + 평점">
            </form>
        ...
        while (i < cafe1.length && j < cafe2.length) {
            if (cafe1[i].cafe_distance <= cafe2[j].cafe_distance) {
                ...
                html += `
                    <div class="listdiv">
                          <div class="list_name" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis"> ${cafe1[i].cafe_name}<br>
                              <div class="list_Rank">1순위</div>
                          </div>
                          <div class="list_address" title="${cafe1[i].cafe_location}">주소 : <br>
                ...
                html += `
                    <div class="listdiv">
                          <div class="list_name" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis"> ${cafe2[j].cafe_name}<br>
                              <div class="list_Rank">2순위</div>
                          </div>
                          <div class="list_address" title="${cafe2[j].cafe_location}">주소 : <br>
                              ${cafe2[j].cafe_location}<br> </div>
                          <div class="list_distance">거리 : ${cafe2[j].cafe_distance}m</div>
                          <div class="list_starRank">별점
                              <div class="star-ratings" style="float: right;">
                                  <!-- width에 별점을 퍼센트로 넣어주세요 -->
                                  <div class="star-ratings-fill space-x-2 text-lg" , style="width: ${scope}%;">
                          ...
                          <div style="display: inline-block;  margin-top: 10px; margin-left: 10px;">
                            ...
                            <a href="#" onclick="javascript:$('#${cafe2[j].cafe_id}').submit();" style="font-size: 18px;">자세히 보기</a>
                          </div>
                          <form action="/mypage/visit_cafe" method="POST">
                            <input type="hidden" name="cafe_id" value="${cafe2[j].cafe_id}">
                            <input class="button2" type="submit" value="Visit & Finish">
        ...
        if (cafe1.length === 0 && cafe2.length === 0) {
            ...
            while (i < cafe3.length) {
                ...
                html += `
                    <div class="listdiv">
                          <div class="list_name" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis"> ${cafe3[i].cafe_name}<br>
                              <div class="list_Rank">3순위</div>
                          </div>
                          <div class="list_address" title="${cafe3[i].cafe_location}">주소 : <br>
