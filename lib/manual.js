                ...
                <li class="slideitem">
                  <div class="textbox" >
                    <div class="content imgLeft">
                        <div class="slideImage"><img src="../image/manual/main.png" alt="../image/manual/main.png"style="width:1400px;height:650px"></div>
                    </div>
                  </div>
                </li>
                <li class="slideitem">
                  <div class="textbox">
                      <div class="content imgRight">
                          <div class="slideImage"><img src="../image/manual/mypage.png" alt="../image/manual/mypage.png"style="width:1400px;height:650px"></div>
                      </div>
                  </div>
              </li>
              <li class="slideitem">
                  <div class="textbox">
                      <div class="content imgLeft">
                          <div class="slideImage"><img src="../image/manual/recommend.png" alt="../image/manual/recommend.png"style="width:1400px;height:650px"></div>
                      </div>
                  </div>
              </li class="slideitem">
              <li class="slideitem">
                  <div class="textbox">
                      <div class="content imgRight">
                          <div class="slideImage"><img src="../image/manual/recommendmap.png" alt="../image/manual/recommendmap.png"style="width:1400px;height:650px"></div>
                      </div>
                  </div>
              </li class="slideitem">
              <li class="slideitem">
                  <div class="textbox">
                      <div class="content imgLeft">
                          <div class="slideImage"><img src="../image/manual/recommendlist.png" alt="../image/manual/recommendlist.png"style="width:1400px;height:650px"></div>
                      </div>
                  </div>
              </li class="slideitem">
              <li class="slideitem">
                  <div class="textbox">
                      <div class="content imgRight">
                            ...
                            <a href="/">
                            <img src="../image/manual/slide6.png" alt="../image/manual/slide6.png"style="width:1400px;height:650px"></div>
                            </a>
                      </div>
                  </div>
              </li class="slideitem">
