...
module.exports = {
    HTML:function(title, id, name, age, gender, phone, birth, location, body, sweet, acidity, bitterness, balance, lat, lon, pro, bean, flist){
      ...
      <body>
          <header><p style="text-align:right;padding-top:30px"><a href="/" style="color: black; text-decoration: none; font-size: larger; font-weight: bolder; margin-right:3%;">Main</a></p></header>
          <main>
