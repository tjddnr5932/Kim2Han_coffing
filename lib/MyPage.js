...
module.exports = {
    HTML:function(title, id, name, age, gender, phone, birth, location, body, sweet, acidity, bitterness, balance, lat, lon, flist){
      return `
      <!DOCTYPE html>
      <html lang="en">
                  ...
                  <tbody>
                      <td align="center" style="width: 33.3%; border-right: 1px solid black;">
                          <div align="left" style="margin-left: 30%;">
                              ...
                              Location <input class="inputA" id="my_Location" type="text" readonly value="${location}" style="margin-left: 0px;"><br>
                              </div>
                          </div>
                      ...
                      <td align="center" style="width: 33.3%; border-right: 1px solid black;">
                          ...
                          <input align="center" class="inputB2" type="text" placeholder="Body" readonly>
                          ...
                          <input class="inputB3" type="submit" value="Select Flavor" style="margin-left: 311px;">
                          </form>
                          <br>
                          ...
                          <form action="/mypage/locationSetting" method="post" class="inputB" class="button">
                      ...
                      <td align="center" style="width:33.3%;">
                          <h1>My Review</h1>
                          <div class="review">
                              <div class="review_cafeName">카페 이름</div>
                              <div class="review_cafeFlavor">맛 평가</div>
                              <div class="review_cafeRating">
                                  <div class='RatingStar1'>
                              ...
                              <div class="review_content">내가 쓴 리뷰 내용</div>
                          </div>
