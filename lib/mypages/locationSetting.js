...
module.exports = {
    HTML:function(title){
      ...
      <h1 align="center" style="margin-top: 4%; margin-left: 12%">추천을 원하시는 위치를 선택해주세요!<select class="inputB" name="distance" style="margin-left: 12%";>
      ...
      <div id="map" style="width:50%;height:450px; margin:0 auto;"></div>
