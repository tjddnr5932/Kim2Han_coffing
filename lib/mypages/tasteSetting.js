    ...
    HTML:function(title){
      ...
      <body>
        ...
        <form action="taste_process" method = "post">
            ...
            <tr>
              <td><p>쓴맛 1</p></td>
              <td><input type="radio" name="btterness" value="1"></td>
              <td><input type="radio" name="btterness" value="2"></td>
              <td><input type="radio" name="btterness" value="3"></td>
              <td><input type="radio" name="btterness" value="4"></td>
              <td><input type="radio" name="btterness" value="5"></td>
              <td><p>5</p></td>
            </tr>
            <tr>
              <td><p>밸런스 1</p></td>
