module.exports={
    html:function(cafe1, cafe2, cafe3, body, sweet, acidity, bitterness, balance){
        html=`
        <!DOCTYPE html>
        <html lang="en">
        ...
        <body>
            ...
            <header>
                <table>
                    <td><input type="button" value="거리 우선 추천" onClick="distance()" style="background-color: #ffcb00; font-weight: bold; border: 1px solid #ffcb00;"></td>
                    <td><input type="button" value="순위 우선 추천" onClick="grade()" style="background-color: #ffcb00; font-weight: bold; border: 1px solid #ffcb00;"></td>
            ...
            while(i<cafe1.length){
                ...
                <div class="listdiv">
                      ...
                      <div class="list_distance">거리 : ${cafe1[i].cafe_distance}</div>
            ...
            while(i<cafe2.length){
                ...
                <div class="listdiv">
                      ...
                      <div class="list_distance">거리 : ${cafe2[i].cafe_distance}</div>
                      <div class="list_starRank">별점
                          <div class="star-ratings" style="float: right;">
                              <!-- width에 별점을 퍼센트로 넣어주세요 -->
                              <div class="star-ratings-fill space-x-2 text-lg" , style="width: ${scope}%;">
                      ...
                      <div style="display: inline-block;  margin-top: 10px; margin-left: 10px;">
                        <form id="${cafe2[i].cafe_id}" name="cform" action="/mypage/view_cafe" method="POST">
                      ...
                      <form name="vform" action="/mypage/visit_cafe" method="POST">
                        <input type="hidden" name="cafe_id" value="${cafe2[i].cafe_id}">
            ...
            if(cafe1.length===0 && cafe2.length===0){
                ...
                while(i<cafe3.length){
                    ...
                    <div class="listdiv">
                          ...
                          <div class="list_distance">거리 : ${cafe3[i].cafe_distance}</div>
                          <div class="list_starRank">별점
                              <div class="star-ratings" style="float: right;">
                                  <!-- width에 별점을 퍼센트로 넣어주세요 -->
                                  <div class="star-ratings-fill space-x-2 text-lg" , style="width: ${scope}%;">
                          ...
                          <div style="display: inline-block;  margin-top: 10px; margin-left: 10px;">
                            <form id="${cafe3[i].cafe_id}" name="cform" action="/mypage/view_cafe" method="POST">
