    ...
    HTML:function(cafe1, cafe2, cafe3, body, sweet, acidity, bitterness, balance, location, title){
        ...
        <body>
            ...
            while(i<cafe2.length){
                ...
                html+=`
                <div class="listdiv">
                      <div class="list_name" style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis"> ${cafe2[i].cafe_name}<br>
                          <div class="list_Rank">2순위</div>
                      </div>
                      <div class="list_address" title="${cafe2[i].cafe_location}">주소 : <br>
                          ${cafe2[i].cafe_location} <br></div>
