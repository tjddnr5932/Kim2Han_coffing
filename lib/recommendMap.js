module.exports = {
    HTML: function (cafe1, cafe2, cafe3, lat, lng, title, kind) {
        var html = `
        <!DOCTYPE html>
        <html>
        <head>
            ...
            * {
            ...
            .map_wrap{width:100%; height:89%;}
            .map{width:100%; height:100%;}
            @font-face {
                font-family: "Machineat_Demo.ttf";
                src: url("../css/Machineat_Demo.ttf");
            }

            @font-face {
                font-family: "NotoSerifKR-Bold";
                src: url("../css/NotoSerifKR-Bold.otf");
            }
            header{
                height:11%;
                font-family: "NotoSerifKR-Bold";
            ...
            .custom_typecontrol {position:absolute;top:10px;right:10px;overflow:hidden;height:30px;margin-top:5.5%;padding:0;z-index:1;font-size:12px;font-family:'Malgun Gothic', '맑은 고딕', sans-serif;}
        ...
        <header>
            <table>
                <td><a> &nbsp Matched Coffee: ${cafe1.length+cafe2.length}</a></td>
       ...
       `
               ...
               content:  '\
                <div class="wrap">\
                    <div class="info">\
                        ...
                        <div class="taste">${kind}${cafe1[i].cafe_bean}</br>`
              ...
              content:  '\
               <div class="wrap">\
                   <div class="info">\
                       ...
                       <div class="taste">${kind}${cafe2[i].cafe_bean}</br>`
               ...
               content:  '\
                <div class="wrap">\
                    <div class="info">\
                        ...
                        <div class="taste">${kind}${cafe3[i].cafe_bean}</br>`
        ...
        var imageSrc = "../image/marker1-001.png";
        ...
        imageSrc = "../image/marker2-001.png";
        ...
        imageSrc = "../image/marker3-001.png";

        for (var i = 0; i < positions3.length; i ++) {
            addMarker(positions3[i]);
        }

        function addMarker(positions3){
            var marker = new kakao.maps.Marker({ // 카페 마커 생성
                map: map,
                title: positions3.title,
                position: positions3.latlng,
                image : new kakao.maps.MarkerImage(imageSrc, imageSize),
            });

            var infowindow = new kakao.maps.InfoWindow({
                content : positions3.content,
                removable : true
            });
